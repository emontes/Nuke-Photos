...
*/               
    ...
    function get_slideshow_thumbnails( $photos = null ) {
        ...
        if ( $photos['photo'] ) {
            foreach ($photos['photo'] as $photo) {
                ...
                // *** Witout using google taps
                //$titleLink = htmlspecialchars("<a href=modules.php?name=".$module_name."&photoId=" . $photo['id'] . ">" . $photo['title'] . " | " . $date . "</a><span class='ui-icon ui-icon-extlink'></span>", ENT_QUOTES);
                // Using Googletaps
                $titleLink = htmlspecialchars("<a href=".MODULE_INDEX."&photoId=" . $photo['id'] . ">" . $photo['title'] . " | " . $date . "</a><span class='ui-icon ui-icon-extlink'></span>", ENT_QUOTES);
    ...
    function get_previous_page_link( $photos, $inner = 'prev' ) {
        ...
        if ( $prevPage ) {
        	...
        	$url = "<a id='prevLink' href=modules.php?";
    ...
    function get_next_page_link( $photos, $inner = 'next' ) {
        ...
        if ( $nextPage ) {
        	...
        	$url = "<a id='nextLink' href=modules.php?";
