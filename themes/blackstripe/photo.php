    ...
    <div id="centercontent">
        ...
        <div id='page_flog'><!-- Build the photo detail floating div -->
            <div id='info_comments'>
                <div>
                    <div class='heading'>
                        <?php $photo->title(); ?>
                    </div>
                    <button id="close" style="position:absolute;top:0;right:0;"><?php echo _CLOSE;?></button>
                </div>
    ...
    <div id='page_flog_meta'><span style='float: left'><?php $photo->dateposted(); ?></span>
