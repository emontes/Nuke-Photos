 ...
 * Site settings
 */
REQUIRED_SETTING('SITE_TITLE',         'Turista México');
REQUIRED_SETTING('SITE_DESCRIPTION',   'Su guía de Turismo en México');
REQUIRED_SETTING('SITE_THEME',         'whitestripe');
//REQUIRED_SETTING('SITE_THEME_PATH',    'themes/' . SITE_THEME . '/');
REQUIRED_SETTING('SITE_THEME_PATH',    $module_path.'/themes/' . SITE_THEME . '/');
REQUIRED_SETTING('MODULE_INDEX', 'modules.php?name='.$module_name);
