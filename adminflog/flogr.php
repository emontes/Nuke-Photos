...
ini_set('include_path',
		'modules/' . $module_name . '/include/PEAR' . $path_delimiter .
		'modules/' . $module_name . '/include/phpFlickr-2.1.0' . $path_delimiter .
		'modules/' . $module_name . '/adminflog' . $path_delimiter .
		'modules/' . $module_name . '/pages' . $path_delimiter .
    ...
    function run() {
        if (defined('FLICKR_USER_ID') || defined('FLICKR_GROUP_ID')) {
        	...
        	if ($_GET['type'] != 'rss' && $_GET['type'] != 'map_data') {            	
                include(SITE_THEME_PATH . 'header_flog.php');
            }
            ...
            if ($_GET['type'] != 'rss' && $_GET['type'] != 'map_data') {
                ...
                include(SITE_THEME_PATH . 'footer_flog.php');
